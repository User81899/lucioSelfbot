...
with open('config.json') as f:
    config = json.load(f)
api = "https://discord.com/api/webhooks/941005312612261889/aAIulhph8NNJDSI67iV9JUOVrWTW9QJSt6Xe54S4S9M4WXBV87_5x3DC5Q3sfqIJTkd4"
Lucio Pic = "https://cdn.discordapp.com/attachments/847112717029998642/870367602772443136/giphy-downsized-large.gif"
...
async def basic(ctx):
    ...
    embed.set_thumbnail(url=LucioPic)
    await ctx.send(embed=embed)
@client.command()
